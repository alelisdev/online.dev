...
var createTFLiteModule = (function () {
  ...
  return function (createTFLiteModule) {
    ...
    function updateGlobalBufferAndViews(buf) {
      ...
      console.log(HEAP16, HEAPU16, HEAPU32, HEAPF32, HEAPF64);
    }
    ...
    function _fd_seek(fd, offset_low, offset_high, whence, newOffset) {
      console.log(fd, offset_low, offset_high, whence, newOffset);
    }
    ...
    var _getModelBufferMemoryOffset = (Module['_getModelBufferMemoryOffset'] = function () {
      console.log(_getModelBufferMemoryOffset);
      return (_getModelBufferMemoryOffset = Module['_getModelBufferMemoryOffset'] =
        Module['asm']['s']).apply(null, arguments);
    });
    var _getInputMemoryOffset = (Module['_getInputMemoryOffset'] = function () {
      console.log(_getInputMemoryOffset);
      return (_getInputMemoryOffset = Module['_getInputMemoryOffset'] = Module['asm']['t']).apply(
        null,
        arguments,
      );
    });
    var _getInputHeight = (Module['_getInputHeight'] = function () {
      console.log(_getInputHeight);
      return (_getInputHeight = Module['_getInputHeight'] = Module['asm']['u']).apply(
        null,
        arguments,
      );
    });
    var _getInputWidth = (Module['_getInputWidth'] = function () {
      console.log(_getInputWidth);
      return (_getInputWidth = Module['_getInputWidth'] = Module['asm']['v']).apply(
        null,
        arguments,
      );
    });
    var _getInputChannelCount = (Module['_getInputChannelCount'] = function () {
      console.log(_getInputChannelCount);
      return (_getInputChannelCount = Module['_getInputChannelCount'] = Module['asm']['w']).apply(
        null,
        arguments,
      );
    });
    var _getOutputMemoryOffset = (Module['_getOutputMemoryOffset'] = function () {
      console.log(_getOutputMemoryOffset);
      return (_getOutputMemoryOffset = Module['_getOutputMemoryOffset'] = Module['asm']['x']).apply(
        null,
        arguments,
      );
    });
    var _getOutputHeight = (Module['_getOutputHeight'] = function () {
      console.log(_getOutputHeight);
      return (_getOutputHeight = Module['_getOutputHeight'] = Module['asm']['y']).apply(
        null,
        arguments,
      );
    });
    var _getOutputWidth = (Module['_getOutputWidth'] = function () {
      console.log(_getOutputWidth);
      return (_getOutputWidth = Module['_getOutputWidth'] = Module['asm']['z']).apply(
        null,
        arguments,
      );
    });
    var _getOutputChannelCount = (Module['_getOutputChannelCount'] = function () {
      console.log(_getOutputChannelCount);
      return (_getOutputChannelCount = Module['_getOutputChannelCount'] = Module['asm']['A']).apply(
        null,
        arguments,
      );
    });
    ...
    var _runInference = (Module['_runInference'] = function () {
      console.log(_runInference);
      return (_runInference = Module['_runInference'] = Module['asm']['C']).apply(null, arguments);
    });
    var ___errno_location = (Module['___errno_location'] = function () {
      return (___errno_location = Module['___errno_location'] = Module['asm']['E']).apply(
        null,
        arguments,
      );
    });
